...
namespace OnlineShop.Services.ProductAPI.Migrations
{
    ...
    [Migration("20220908141315_AddDefaultProductsToDb")]
    partial class AddDefaultProductsToDb
    {
            ...
            modelBuilder.Entity("OnlineShop.Services.ProductAPI.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7e8b035a-bbbf-4f54-ae72-33a8f465ddef"),
                        ...
                        new
                        {
                            Id = new Guid("d3448cd5-84b7-4c3a-983a-a08cb711d30b"),
                            CategoryName = "Ноутбук",
                        ...
                        new
                        {
                            Id = new Guid("93bbd2b7-f83c-47b2-a7ea-535df37f0ba2"),
                            CategoryName = "Ноутбук",
